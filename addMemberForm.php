    ...
    <body id="pageBody">
            ...
            <div class="contentArea">
                ...
                <div class="divPanel notop page-content">
                    ...
                    <div class="breadcrumbs">
                        <a href="index.php">Home</a> &nbsp;/&nbsp; <a href="admin.php">Admin Panel</a> &nbsp;/&nbsp; <a href="viewMembers.php">Members</a> &nbsp;/&nbsp; <span>Add Member Form</span>
                    </div>
        ...
        <div class="tab-content">
                                ...
                                <div id="login">   
                                    ...
                                    <form action="addMember.php" method="post" autocomplete="off">
                                        ...
                                        <button type="submit" class="button button-block" name="register" />Add Member </button>
