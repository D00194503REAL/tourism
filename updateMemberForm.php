            ...
            <div class="contentArea">
                ...
                <div class="divPanel notop page-content">
                    ...
                    <div class="breadcrumbs">
                        <a href="index.php">Home</a> &nbsp;/&nbsp; <a href="admin.php">Admin Panel</a> &nbsp;/&nbsp; <a href="viewMembers.php">Members</a> &nbsp;/&nbsp; <span>Update Member Form</span>
                    </div>
                        ...
                        <div class="form">
                            ...
                            <div class="tab-content">
                                ...
                                <div id="login">   
                                    ...
                                    <form action="updateMember.php" method="post" autocomplete="off">
                                        ...
                                        <div class="top-row">
                                            <div class="field-wrap">
                                                ...
                                                <input type="text" id="first_name" name="first_name" size="30"  title="first_name" required pattern="[A-Za-z]+">
                                            </div>

                                            <div class="field-wrap">
                                                <label for="last_name">Last name<span class="req">*</span></label>
                                                <input type="text" id="last_name" name="last_name" size="30"  title="last_name" required pattern="[A-Za-z]+">
                                            </div>
                                        </div>

                                        <div class="field-wrap">
                                            <label for="email">E-mail<span class="req">*</span></label>
                                            <input type="email" id="email" name="email" size="30"  title="email" required/>
                                        </div>
                                        <hr>
                                        <hr>
                                        <div class="field-wrap">
                                        ...
                                        <button type="submit" class="button button-block" name="register" />Update</button>
