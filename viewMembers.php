    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
            ...
            <div class="breadcrumbs">
                <a href="index.php">Home</a> &nbsp;/&nbsp; <a href="admin.php">Admin Panel</a> &nbsp;/&nbsp; <span>Members</span>
            </div>
                ...
                <div class="main">
                    ...
                    <table>
                        ...
                        while ($row = $query->fetch()) {
                            ...
                            echo "<td><a href='updateMemberForm.php?id=" . $row["id"] . "'>Update</a>";
                            echo "<td><a href='deleteMember.php?id=" . $row["id"] . "'>Delete</a>";
                            echo "</tr>";
                        }
