    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
            ...
            <div class="breadcrumbs">
                <a href="index.php">Home</a> &nbsp;/&nbsp; <a href="admin.php">Admin Panel</a> &nbsp;/&nbsp; <a href="viewMembers.php">Members</a> &nbsp;/&nbsp; <a href="viewMembers.php">Update Member Form</a> &nbsp;/&nbsp; <span>Update Member</span>
            </div>
            ...
            <div class="main">
                ...
                try {
                    ...
                    $query = "UPDATE users SET first_name=:first_name, last_name=:last_name, email=:email, active=:active, admin=:admin WHERE id=:id";
                    ...
                    echo '<h1>You have Updated ' . $first_name . ' Profile</h1><a href="viewMembers.php">View Members</a>';
