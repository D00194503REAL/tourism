                        ...
                        <div class="nav-collapse collapse">
                            <ul class="nav nav-pills ddmenu">
								...
								<li class="dropdown">
                                    ...
                                    <li><a href="contact.php">Sign-Up/Login</a></li>
    ...
    <div class="contentArea">
        ...
        <div class="divPanel notop page-content">
            ...
            <div class="breadcrumbs">
                <a href="index.php">Home</a> &nbsp;/&nbsp; <span>Admin Panel</span>
            </div>
            <hr>
            <hr>
...
<div class="form">
    ...
    <a href="contact.php"><button class="button button-block"/>Home</button></a>
</div>
<!--Edit Footer here-->
